  ...
  <el-form :model="user" label-width="120px" :rules="rules" ref="ruleFormRef">
    ...
    <el-form-item label="longitude" prop="longitude">
      <el-input-number
        ...
        data-test="userFormlongitude"
      />
    </el-form-item>
    <el-form-item label="skills" prop="skills">
      <el-input v-model="user.skills" data-test="userFormskills" />
    </el-form-item>
    <el-form-item label="phoneNumber" prop="phoneNumber">
      <el-input-number
        ...
        data-test="userFormphoneNumber"
      />
    </el-form-item>
    <el-form-item label="preferencesCategory" prop="preferencesCategory">
      <el-input
        v-model="user.preferencesCategory"
        type="textarea"
        data-test="userFormpreferencesCategory"
      />
    </el-form-item>
    <el-form-item label="professionCategory" prop="professionCategory">
      <el-input
        v-model="user.professionCategory"
        data-test="userFormprofessionCategory"
      />
    </el-form-item>
